...
export default class Expense extends Component {
  ...
  render() {
    ...
    console.log(tableData);
        ...
        <View style={{elevation:5,backgroundColor:'white', flex:1.5, justifyContent: 'center', alignItems: 'center' }}>
          
          
         
          
          <Text style={styles.mainText}>ALL EXPENCES</Text>
...
const styles = StyleSheet.create({
    ...
    header: { 
      height: 50, backgroundColor: '#b71540' },
    text: { 
